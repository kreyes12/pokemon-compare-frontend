        ...
        <div className='tile is-ancestor'>
          <div className='tile is-parent is-vertical'>
            { this.props.selectedPoketeam
              ? <PoketeamCard poketeam={this.props.selectedPoketeam} viewAllPoketeams={this.props.viewAllPoketeams} handleClick={this.props.handClick} />
              : this.props.poketeams.map(singlePoketeam =>
                <div className='tile is-vertical box'>
                  ...
                  <PoketeamsCard showPoketeam={this.props.showPoketeam} poketeam={singlePoketeam} deletePoketeam={this.props.deletePoketeam} />
                </div>
              )}
          </div>
        </div>
